...
- Returning Meraki dashboard [webhooks](https://developer.cisco.com/meraki/webhooks/)
- Triggering dashboard webhooks on-demand
- People counting with [MV Sense](https://developer.cisco.com/meraki/mv-sense/) MQTT
